    ...
    <div className="min-h-screen bg-white text-gray-800">
      ...
      <aside className="hidden md:flex h-screen w-64 fixed left-0 top-0 bg-[#1B4332] flex-col p-2 gap-1 z-50">
        ...
        <nav className="flex-1 space-y-1">
          <Link to="/dashboard" className="flex items-center gap-3 px-3 py-2 text-white/70 hover:bg-white/10 rounded-lg text-sm font-medium">
            Dashboard
          </Link>
          <Link to="/sessoes" className="flex items-center gap-3 px-3 py-2 bg-[#2D6A4F] text-white rounded-lg text-sm font-bold">
            Sessoes
          </Link>
          <Link to="/perfil" className="flex items-center gap-3 px-3 py-2 text-white/70 hover:bg-white/10 rounded-lg text-sm font-medium">
            Perfil
          </Link>
        </nav>
        <button
        ...
        <div className="mt-4 pt-4 border-t border-white/10 space-y-1">
          <Link to="/" className="flex items-center gap-3 px-3 py-2 text-white/70 hover:bg-white/10 rounded-lg text-sm">
            Sair
          </Link>
        </div>
      </aside>
